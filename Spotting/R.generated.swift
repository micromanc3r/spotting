...
struct R: Rswift.Validatable {
    ...
    struct file {
        ...
        /// Resource file `GooglePlaces.bundle`.
        static let googlePlacesBundle = Rswift.FileResource(bundle: R.hostingBundle, name: "GooglePlaces", pathExtension: "bundle")
        ...
        /// `bundle.url(forResource: "GooglePlaces", withExtension: "bundle")`
        static func googlePlacesBundle(_: Void = ()) -> Foundation.URL? {
            let fileResource = R.file.googlePlacesBundle
            return fileResource.bundle.url(forResource: fileResource)
        }
    ...
    struct string {
        ...
        struct localizable {
            ...
            /// Value: Name of the spot
            static let new_spot_form_name = Rswift.StringResource(key: "new_spot_form_name", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
            /// Value: New Spot
            ...
            /// Value: Comments
            static func spot_comments(_: Void = ()) -> String {
                return NSLocalizedString("spot_comments", bundle: R.hostingBundle, comment: "")
            }
            ...
            /// Value: Name of the spot
            static func new_spot_form_name(_: Void = ()) -> String {
                return NSLocalizedString("new_spot_form_name", bundle: R.hostingBundle, comment: "")
            }
